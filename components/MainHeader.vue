      ...
      <div class="xl:container m-auto px-6 md:px-12 lg:px-6">
        ...
        >
          ...
          >
            ...
            <div
              class="w-full space-y-2 text-primary dark:text-wite border-primary/10 dark:border-gray-700 flex flex-col -ml-1 sm:flex-row lg:space-y-0 md:w-max lg:border-l"
            >
              <NuxtLink
                to="#"
              ...
              >
                <span
                  class="relative text-sm font-semibold dark:text-primaryLight"
                  >注册</span
                >
              </NuxtLink>
              <NuxtLink
              ...
              >
                <span class="relative text-sm font-semibold">登录</span>
              </NuxtLink>
            </div>
          </div>
        </div>
