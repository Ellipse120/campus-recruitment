    ...
    >
      <div class="w-full">
        <div class="md:pt-3 w-full md:gap-0 lg:pt-5">
          <div
            class="w-full items-center flex justify-center lg:w-auto divide-gray divide-x"
          >
            <a
              class="relative z-10 flex items-center justify-center text-3xl pr-3"
              href="/"
              aria-label="logo"
              @click="toggle(false)"
            >
          ...
          <div
            ref="menuRef"
            class="navmenu w-full"
          >
            <div class="text-black flex items-center justify-center w-full bg-gray-100 dark:text-gray-300 dark:bg-gray-8 mt-5 lg:pr-4">
              <div
